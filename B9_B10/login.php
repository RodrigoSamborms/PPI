        ...
        function validarFormulario() {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (response == '1') {
                        // Login exitoso - redirigir a index.php
...
<body>
    <div style="max-width: 600px; margin: 100px auto; background-color: white; padding: 40px; border-radius: 8px; box-shadow: 0 2px 5px rgba(0,0,0,0.1);">
        <h1>Sistema de Gestión de Empleados</h1>
        <h2 style="text-align: center; color: #666;">Inicio de Sesión</h2>
