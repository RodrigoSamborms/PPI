...
// Consultar los datos del empleado - solo empleados activos (incluir imagen)
$sql = "SELECT id, nombre, apellidos, correo, rol, imagen FROM empleados WHERE id = $id_empleado AND eliminado = 0";
...
<body>
    ...
    <form id="formEditarEmpleado" action="empleados_editar.php" method="POST" enctype="multipart/form-data">
        ...
        <?php if (!empty($empleado['imagen'])): ?>
            <p style="color: #666; font-size: 12px; margin-top: -10px;">
                Imagen actual: <?php echo htmlspecialchars($empleado['imagen']); ?>
            </p>
        <?php endif; ?>
